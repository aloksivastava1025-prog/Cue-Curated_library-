...
const PAGES = {
  ...
  terms: {
    ...
    body: [
      ...
      ['3. Plans and payment',
        `The Free tier gives you preview access to selected items. Cue+ Founding Lifetime is a one-time purchase of USD $99 that unlocks the full library and every future drop for a single named user. Founding pricing is capped at the first 50 members; after that, the standard price is USD $249. Prices are shown in USD; local currency and applicable taxes (including Indian GST where relevant) are calculated by our payment partner at checkout based on your region. Payment is processed by Dodo Payments; CUE never sees or stores your card data.`],
