...
const PAGES = {
  ...
  terms: {
    ...
    body: [
      ...
      ['3. Plans and payment',
        `The Free tier gives you preview access to selected items. Cue+ Founding Lifetime is a one-time purchase — USD $99 globally, or INR ₹4,999 for buyers in India (regional purchasing-power pricing, auto-applied at checkout by our payment partner). It unlocks the full library and every future drop for a single named user. Founding pricing is capped at the first 50 members; after that, the standard price is USD $249 (or the equivalent regional rate). Applicable taxes (including Indian GST where relevant) are added at checkout. Payment is processed by Dodo Payments; CUE never sees or stores your card data.`],
