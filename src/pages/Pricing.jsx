...
const FAQ = [
  ...
  { q: 'What if I don\'t like it?', a: "Then don't buy it. Seriously — the free tier has 30+ premium components already open with full prompt and code. Ship one, see if the quality matches what you need, then decide. That's a real trial, not a limited-time tease. If after that you still pay and something is genuinely off, email hello@cuedesign.space within 24 hours of purchase and I'll refund you — full details on the Refund page." },
