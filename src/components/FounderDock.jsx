...
export default function FounderDock() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Contact icon — phone handset. Reads as "reach out" at a
            glance instead of a portrait, so first-time visitors know
            the dock is a support channel, not a profile widget. The
            founder's photo still shows up inside the expanded card. */}
        <span className="cue-founder-contact-icon" aria-hidden="true">
