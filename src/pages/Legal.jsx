...
const PAGES = {
  ...
  terms: {
    ...
    body: [
      ...
      ['3. Plans and payment',
        `The Free tier gives you preview access to selected items. Cue+ has two paid tiers: (a) Cue+ Founding Lifetime — a one-time purchase of USD $99 that unlocks the full library and every future drop for a single named user (founding pricing is capped at the first 50 members; standard lifetime is USD $249 after); (b) Cue+ Monthly — USD $49 per month, auto-renewing, cancel anytime. Prices shown are in USD and do NOT include tax — applicable local taxes (Indian GST at 18%, UK/EU VAT at 20%, or your regional sales tax) are calculated and added on top at checkout by our payment partner. Business buyers with a valid VAT ID may qualify for reverse charge (no VAT collected). Local currency is automatically selected at checkout based on your region. Payment is processed by Dodo Payments; CUE never sees or stores your card data.`],
